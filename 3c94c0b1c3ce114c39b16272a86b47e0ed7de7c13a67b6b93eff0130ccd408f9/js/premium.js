function calculate() {
  ...
  if (classValue === "1") { // 個人事業主
    ...
    if (planValue === "1") {
      ...
      legalConsultationText = "11万円・3回/年";
      attorneyFeeText = "100万円・3回/年";
      specialClauseText = "弁護士費用保険金（報酬金等対応分）不担保特約・代表者個人補償特約";
    } else if (planValue === "2") {
      premium = timesValue === "1" ? 52800 : 633600;
      legalConsultationText = "11万円・3回/年";
      attorneyFeeText = "200万円・3回/年";
      specialClauseText = "代表者個人補償特約";
    }
